...
public class RobotMap {
    ...
    public static final Pose2d BLUE_HUMAN_PLAYER_OUTPUT_CENTER_POSE2D = new Pose2d(0.1, 0.7, new Rotation2d());
    public static final Pose2d RED_HUMAN_PLAYER_OUTPUT_CENTER_POSE2D = new Pose2d(16.4, 7.4, new Rotation2d());
